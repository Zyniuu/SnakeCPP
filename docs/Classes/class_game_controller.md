...
|                | Name           |
| -------------- | -------------- |
| | **[GameController](class_game_controller.md#function-gamecontroller)**()<br>Initializes the game (creates snake and fruit).  |
| void | **[handleInput](class_game_controller.md#function-handleinput)**(const WPARAM & keyCode)<br>Handles player input.  |
| bool | **[update](class_game_controller.md#function-update)**()<br>Updates the game state (moves snake, checks collisions).  |
| void | **[render](class_game_controller.md#function-render)**(class [Renderer](class_renderer.md) & renderer)<br>Renders the game objects using the provided renderer.  |
